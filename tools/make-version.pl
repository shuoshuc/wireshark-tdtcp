...
sub read_repo_info {
	...
	my $git_archive_commit = '9733f173ea5e6255e8da208ef183210aa264d948';
	my @git_refs = split(/, /, 'tag: wireshark-3.4.0, tag: v3.4.0, refs/merge-requests/785/head, refs/keep-around/9733f173ea5e6255e8da208ef183210aa264d948');
